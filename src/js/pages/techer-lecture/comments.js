                    ...
                    <div className='row b40'>
                        <div className='col-md-8'>
                            ...
                            <div className='comment'>
                                <div className='img f-blue'> <div> <img src={ImgPath}/> </div> online </div>
                                <a href='' className='f-blue'>Припачева<br/> Иладзе Владимировна</a>
                                <p className='f-gray'>Sed ut perspiciatis, unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam eaque ipsa, quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt, explicabo. Nemo enim ipsam voluptatem, quia voluptas sit, aspernatur aut odit</p>
